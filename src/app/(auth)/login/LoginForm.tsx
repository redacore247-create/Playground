    ...
    <div className="space-y-6">
      ...
      <div className="card-dark p-6 space-y-5">
        ...
        <form action={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input name="email" type="email" required autoComplete="email"
                placeholder="you@example.com" className="input-glass w-full pl-10" />
            </div>
          </div>
          ...
          <button type="submit" disabled={isPending || isGooglePending} className="btn-primary w-full py-3 text-base">
            {isPending ? <><Loader2 className="w-4 h-4 animate-spin" />Signing in...</> : <><Zap className="w-4 h-4" />Sign in</>}
          </button>
        </form>
      </div>
